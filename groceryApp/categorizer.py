...
input_file = "./groceryApp/data/grocery_list.txt"
output_file = "./groceryApp/data/categorized_grocery_list.txt"

# Check for exsistance of the input file
if not os.path.exists(input_file):
    print(f"Input file '{input_file}' not found.")
    exit(1)

# Read Uncategorized items from the input file
with open(input_file,"r") as f:
    items = f.read().strip()

# Promt to categorize items
prompt = f""" 
